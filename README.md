...
- **Bitcoin Game**: Added an interactive bitcoin trading/price tracking game
- **Improved Price Progress Indicator**: The barometer (price progress indicator) now uses responsive margins (`top-20 bottom-8`) instead of fixed height for better scaling across different container sizes
- **Enhanced Range**: Updated maximum value support to 120,000 for broader data visualization capabilities
- **Multiple Bug Fixes**: Various stability and performance improvements
